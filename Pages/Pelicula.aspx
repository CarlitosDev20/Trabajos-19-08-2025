<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/cinestar.Master" AutoEventWireup="true" CodeBehind="Pelicula.aspx.cs" Inherits="webCinestar_webForm_1808.Pages.Pelicula" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">

    <asp:FormView ID="pelicula" runat="server">
        <ItemTemplate>
